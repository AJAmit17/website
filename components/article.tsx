...
import { getTrafficPageViews } from "@/lib/data";
import { getDependabotAlerts } from "@/lib/data";
import { Eye } from "lucide-react";
import { GitHubLogoIcon } from "@radix-ui/react-icons";

export const Article = async ({ project }: { project: any }) => {
        ...
        <article className="p-4 md:p-8">
            <div className="flex justify-between gap-2 items-center">
                <span className="text-xs duration-1000 text-zinc-200 group-hover:text-white group-hover:border-zinc-200 drop-shadow-orange">
                    {/* <Image src={`https://raw.githubusercontent.com/jirihofman/${project.name}/${project.default_branch}/public/favicon.ico`} alt={project.name} width={24} height={24} /> */}
